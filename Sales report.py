...
gif_path = r"C:\Users\hjjung\Documents\교육자료\개인폴더\개인\업무자동화\9. Sales report\images\Sales report.gif"
...
if uploaded_files:
    ...
    with col1:
        image_path = r"C:\Users\hjjung\Documents\교육자료\개인폴더\개인\업무자동화\9. Sales report\images\sales2.png"
        try:
    ...
    with col1:
        image_path = r"C:\Users\hjjung\Documents\교육자료\개인폴더\개인\업무자동화\9. Sales report\images\year.png"
        try:
            image = Image.open(image_path)
            st.image(image, caption=None, use_container_width=True)
        except FileNotFoundError:
    ...
    if "EOH+OT U" in data.columns:
        ...
        with col1:
            image_path = r"C:\Users\hjjung\Documents\교육자료\개인폴더\개인\업무자동화\9. Sales report\images\warehouse.png"
            try:
                image = Image.open(image_path)
                st.image(image, caption=None, use_container_width=True)
            except FileNotFoundError:
        ...
        with col1:
            image_path = r"C:\Users\hjjung\Documents\교육자료\개인폴더\개인\업무자동화\9. Sales report\images\interest-rate.png"
            try:
                image = Image.open(image_path)
                st.image(image, caption=None, use_container_width=True)
            except FileNotFoundError:
        ...
        if "REG SALES $" in grouped_data.columns and "PROMO SALES $" in grouped_data.columns and "CLEAR SALES $" in grouped_data.columns:
            ...
            with col1:
                image_path = r"C:\Users\hjjung\Documents\교육자료\개인폴더\개인\업무자동화\9. Sales report\images\margin.png"
                try:
                    image = Image.open(image_path)
                    st.image(image, caption=None, use_container_width=True)
                except FileNotFoundError:
        ...
        with col1:
            image_path = r"C:\Users\hjjung\Documents\교육자료\개인폴더\개인\업무자동화\9. Sales report\images\forecasting.png"
            try:
                image = Image.open(image_path)
                st.image(image, caption=None, use_container_width=True)
            except FileNotFoundError:
        ...
        with col1:
            image_path = r"C:\Users\hjjung\Documents\교육자료\개인폴더\개인\업무자동화\9. Sales report\images\contribution.png"
            try:
                image = Image.open(image_path)
                st.image(image, caption=None, use_container_width=True)
            except FileNotFoundError:
        ...
        with col1:
            image_path = r"C:\Users\hjjung\Documents\교육자료\개인폴더\개인\업무자동화\9. Sales report\images\key.png"
            try:
                image = Image.open(image_path)
                st.image(image, caption=None, use_container_width=True)
            except FileNotFoundError:
